package org.zarroboogs.radialmenu;
...
import org.zarroboogs.radialmenu.RadialMenuWidget.RadialMenuEntry;
...
public class RadialMenuMainActivity extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Generating Pie view
        //------------------------------------------------------------------------------------------
        setContentView(R.layout.activity_radial_menu_main);
...
/*				try {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        if (state == MotionEvent.ACTION_DOWN) {
            ...
            Toast.makeText(getApplicationContext(), "Screen Touched!",
                    Toast.LENGTH_SHORT).show();
